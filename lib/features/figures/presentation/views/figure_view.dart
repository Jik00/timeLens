...
import 'package:timelens/features/figures/presentation/views/widgets/figures_view_bloc_builder.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => GetFiguresListCubit(
        figureRepo: getIt.get<FigureRepo>()..getFigures(eraName: eraName),
      ),
      child: Scaffold(
        ...
        extendBody: true,
        body: FiguresViewBlocBuilder(eraName: eraName),
      ),
    );
  }
}
