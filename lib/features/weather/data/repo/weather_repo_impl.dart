...
class WeatherRepoImpl implements WeatherRepo{
  ...
  @override
  Future<Either<Failure, WeatherDetailsEntity>> getWeatherDetails(String cityName) async {
    ...
    try {
      ...
      return Right( model.toWeatherDetailsEntity() );
  ...
  @override
  Future<Either<Failure, SearchLocationWeatherEntity>> searchLocation(String cityName) async {
