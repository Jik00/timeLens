...
class Hour extends Equatable {
  ...
  factory Hour.fromMap(Map<String, dynamic> data) => Hour(
        ...
        windDegree: ( data['wind_degree'] as num?)?.toInt(),
        ...
        snowCm: (data['snow_cm'] as num?)?.toInt(),
        ...
        willItRain: (data['will_it_rain'] as num?)?.toInt(),
        chanceOfRain: (data['chance_of_rain'] as num?)?.toInt(),
        willItSnow: (data['will_it_snow'] as num?)?.toInt(),
        chanceOfSnow: (data['chance_of_snow'] as num?)?.toInt(),
