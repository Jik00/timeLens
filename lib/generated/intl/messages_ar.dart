...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "instructions1": MessageLookupByLibrary.simpleMessage(
      "١. ضع نظارة الواقع الافتراضي وتأكد من ضبطها بشكل مريح.",
    ),
    "instructions2": MessageLookupByLibrary.simpleMessage(
      "٢. استخدم وحدات التحكم للتنقل والتفاعل مع العناصر.",
    ),
    "instructions3": MessageLookupByLibrary.simpleMessage(
      "٣. اتبع التعليمات على الشاشة للوصول إلى الميزات المختلفة.",
    ),
    "instructions4": MessageLookupByLibrary.simpleMessage(
      "٤. للتحدث مع الشخصيات، اقترب من المنطقة المخصصة وابدأ الحديث.",
    ),
    "instructions5": MessageLookupByLibrary.simpleMessage(
      "٥. استمتع باستكشاف العالم الافتراضي وتعرّف على التاريخ.",
    ),
    ...
    "thothCanMakemistakes": MessageLookupByLibrary.simpleMessage(
      "قد يُخطئ توت، والحكمة في تطور دائم",
    ),
    "thothWhatWouldU": MessageLookupByLibrary.simpleMessage(
      "ماذا تودّ أن تعرف؟",
    ),
    "timeTraveler": MessageLookupByLibrary.simpleMessage("مسافر الزمن"),
